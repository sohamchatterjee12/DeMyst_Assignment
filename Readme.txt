...
1) Make sure Docker for Windows is installed and running on your laptop.

2) Clone the Assignment repository onto your local machine.

3) Go inside the cloned folder and open Windows terminal.
